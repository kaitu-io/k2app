  ...
  posts: [
    {
      ...
      summary: '深入对比 k2 自研自适应拥塞控制算法与 Hysteria2 Brutal 固定发送速率机制的差异。',
      tags: ['k2', 'comparison', '拥塞控制'],
      draft: false,
      content: '<h1>k2 vs Hysteria2</h1><p>自研自适应拥塞控制算法</p><p>丢包恢复</p><p>延迟稳定性</p><p>带宽利用率</p><p>公平性</p>',
    ...
    },
    {
      ...
      date: '2026-02-21T00:00:00.000Z',
      summary: 'An in-depth comparison of k2 proprietary adaptive congestion control algorithm versus Hysteria2 Brutal fixed-rate sending.',
      tags: ['k2', 'comparison', 'congestion control'],
      draft: false,
      content: '<h1>k2 vs Hysteria2</h1><p>proprietary adaptive congestion control algorithm</p><p>packet loss recovery</p><p>latency stability</p><p>bandwidth utilization</p><p>fairness</p>',
      metadata: { readingTime: 5, wordCount: 800 },
