...
- k2cc adaptive rate control optimizes throughput on high packet-loss networks (see [k2cc](/k2/k2cc))
...
Next: [k2cc Adaptive Rate Control](/k2/k2cc) for the congestion control algorithm, or [Stealth Camouflage](/k2/stealth) for the threat model and how each mechanism addresses it.
