...
| 文档 | 说明 |
|------|------|
| [1 分钟快速开始](quickstart) | 一分钟内启动服务端并连接 |
| [k2s 服务端部署](server) | 详细的服务端安装与配置 |
| [k2 客户端使用](client) | 客户端安装与常用命令 |
| [协议技术详解](protocol) | 深入了解 k2v5 协议实现 |
| [隐身伪装技术](stealth) | ECH、TLS 指纹、主动探测对抗原理 |
