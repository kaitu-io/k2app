...
date: 2026-02-22
summary: "k2cc 自适应速率控制 vs Hysteria2 Brutal 固定速率 vs BBR：14 种网络场景测评框架，审查网络中的真实表现对比。"
section: comparison
order: 8
draft: false
---
...
- 参考文献：RFC 8867、QUICbench (IMC 2022)、[USENIX Security 2023](https://gfw.report/publications/usenixsecurity23/en/)、[USENIX Security 2025](https://gfw.report/publications/usenixsecurity25/en/)
...
BBR 没有审查感知能力。在 GFW 26% 概率性丢包环境中，BBR 将审查丢包误判为拥塞，严重低估可用带宽。k2cc 能区分拥塞丢包和审查丢包，维持远高于 BBR 的吞吐量。详见 [k2cc vs BBR](/k2/vs-bbr)。
