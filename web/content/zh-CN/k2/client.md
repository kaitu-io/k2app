...
title: k2 客户端使用
date: 2026-02-22
summary: 在 Linux 或 macOS 上安装 k2 命令行客户端，连接 k2 服务端。k2cc 自动探测最优速率，无需手动配置带宽。
...
当 QUIC 不可用时，协议自动切换为 `k2 (TCP-WS)`，无需手动干预。
...
接下来阅读：[k2cc 自适应速率控制](/k2/k2cc) 了解拥塞控制算法，[k2 协议架构](/k2/protocol) 了解协议技术细节。
