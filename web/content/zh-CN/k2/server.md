...
title: k2s 服务端部署
date: 2026-02-22
summary: 在 Linux VPS 上一键安装并运行 k2s 服务端。零配置启动——自动生成密钥证书，k2cc 自动优化传输性能。
...
k2s 是 k2 协议的服务端程序，设计目标是**零配置启动**。您只需一条命令，服务端即可自动完成所有密钥生成和服务注册。k2cc 在服务端同步启用，自动优化传输性能。
...
接下来阅读：
- [k2 客户端使用](/k2/client) — 了解如何连接到您部署的服务端
- [端口跳跃配置](/k2/hop-ports) — 通过 UDP 端口跳跃提升连接稳定性
