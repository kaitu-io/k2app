...
title: k2s 服务端部署
date: 2026-02-21
summary: 在 Linux VPS 上一键安装并运行 k2s 服务端。包括系统服务配置、Docker 部署、高级参数和常见问题。
...
k2s 是 k2 协议的服务端程序，设计目标是**零配置启动**。您只需一条命令，服务端即可自动完成所有密钥生成和服务注册。
...
public_name: cloudflare-ech.com  # ECH 外层域名（用于主动探测伪装）
...
接下来阅读：[k2 客户端使用](client) 了解如何连接到您部署的服务端。
