...
title: k2cc 自适应速率控制
date: 2026-02-22
summary: k2cc 是 k2 自研的拥塞控制算法，专为高审查、高丢包网络设计。自动探测最优发送速率，区分审查丢包与拥塞丢包，无需手动配置带宽参数。
section: technical
order: 5
draft: false
---
...
接下来阅读：[隐身伪装技术](/k2/stealth) 从威胁模型角度分析 k2 的对抗能力，[k2 vs Hysteria2](/k2/vs-hysteria2) 查看 k2cc 与 Brutal/BBR 的性能对比，或 [k2 vs VLESS+Reality](/k2/vs-reality) 了解 k2 与 Reality 的隐身路线对比。
