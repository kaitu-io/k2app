...
export const namespaces = ["common","nav","hero","auth","discovery","purchase","wallet","campaigns","admin","invite","install","theme","changelog","releases","routers","k2","guide-parents","errors","licenseKeys","survey","account","landing"] as const;
