; Kaitu Desktop - Custom NSIS Language Strings (Simplified Chinese)
...
LangString windowsVersionTooOld ${LANG_SIMPCHINESE} "${PRODUCTNAME} 需要 Windows 10 版本 1809 (Build 17763) 或更高版本。$\n$\n您当前的 Windows 版本不受支持。$\n请升级您的 Windows 系统后再继续安装。"
