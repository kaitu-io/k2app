; Kaitu Desktop - Custom NSIS Language Strings (English)
; These strings extend/override Tauri's default NSIS language strings
;
; IMPORTANT: When using customLanguageFiles, you must include ALL language strings
; because it completely replaces the default Tauri language file.

; ============================================================================
; Tauri Default Language Strings (copied from tauri-bundler)
; ============================================================================
...
; ============================================================================
; Custom Language Strings for Kaitu
; ============================================================================

; Windows version check error message
; Displayed when user tries to install on Windows versions older than Windows 10 1809
LangString windowsVersionTooOld ${LANG_ENGLISH} "${PRODUCTNAME} requires Windows 10 version 1809 (Build 17763) or later.$\n$\nYour current Windows version is not supported.$\nPlease upgrade your Windows to continue."
