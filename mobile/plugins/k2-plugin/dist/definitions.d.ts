...
export interface K2PluginInterface {
    ...
    addListener(eventName: 'iapTransactionUpdate', handler: (data: {
        transactionId: string;
        productId: string;
    }) => void): Promise<PluginListenerHandle>;
}
