...
type LicenseKey struct {
	...
	Code string `gorm:"type:varchar(8)" json:"code"` // Phase 1: nullable, no index. After backfill confirms all rows have codes, add uniqueIndex;not null in a follow-up deploy.
