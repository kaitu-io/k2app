...
// (Warn80SentEpoch / Warn95SentEpoch) round-trip through the DB. The Task 4
// warn worker compares these against TrafficEpoch to fire 80/95% alerts at most
// once per billing epoch.
func TestCloudInstanceWarnEpochColumns(t *testing.T) {
	...
	ci := &CloudInstance{
		...
		Warn80SentEpoch: 7, Warn95SentEpoch: 0,
	}
	...
	require.Equal(t, int64(0), got.Warn95SentEpoch)
}
