...
*Updated: 2026-07-14 — 决策：**开途 与 Overleap 是两个完全隔离的对等品牌**（推翻 2026-04-21 的母品牌 / 子产品层级）。本文档为终局形态；迁移动作见 content-calendar W1 + ASO audit P1/P2。*

## 品牌架构

**开途**（中国）与 **Overleap**（海外）是两个各自独立运作的产品品牌 —— **没有母子关系，没有公司层 / 产品层之分**。协议层 k2 / k2cc 与硬件产品线 k2r 不属于任一品牌，全球共享。

| 层 | 名称 | 适用场景 |
|------|------|---------|
| **中国品牌** | 开途（kaitu.io） | kaitu.io · 小红书 / 知乎 / 微博 · 中国区 App Store · 国内分销 / 客服 |
| **海外品牌** | Overleap（overleap.io） | overleap.io · 英文 Twitter / Reddit / HN · 全球 App Store / Google Play · 英文 press |
...
- **海外面**（overleap.io / 英文 Twitter / Reddit / HN / 全球 App Store / Google Play）：只出现 "Overleap"，不提 Kaitu / 开途。
- **没有跨语境衔接。** ~~"Kaitu by Overleap"~~ / ~~"Kaitu, a product of Overleap"~~ **已作废，禁止使用**（2026-07-14）。英文 press、跨市场技术博客、招聘页一律选定一个品牌叙事，不做关联。
- **唯一例外：法务文书署名。** ToS / 隐私政策 / footer 的法律实体署名两边都是 **Overleap LLC**。这是刻意收窄的单点例外 —— 不要据此在叙事层重建关联。
...
- ~~开途VPN by Overleap~~ / ~~Kaitu by Overleap~~ / ~~Overleap by Kaitu~~ — **任何方向的品牌衔接都禁止**（2026-07-14 起两品牌完全隔离）。"Kaitu by Overleap" 曾在 2026-04-21 被指定为正确写法，现已作废。
